This is a simple web application that allows users to add new users and view a table of all the users that have been added. It was built using React and CSS, and utilizes webpack for bundling.
